...
final class TranscriptDetailsViewController: PMBaseViewController {
    ...
    @objc private func shareButtonAction() {
        ...
        AppConfigService.shared.analytics.track(action: .v2TranscriptDetailsScreen, with: [AnalyticsAction.action.rawValue: AnalyticsAction.share.rawValue])
    }
    ...
    @objc private func trashButtonAction() {
        ...
        let yesAction = UIAlertAction(title: "Yes!".localized(), style: .default) { [weak self] _ in
            if let index = self?.transcriptModelIndex {
                ...
                AppConfigService.shared.analytics.track(action: .v2TranscriptDetailsScreen, with: [AnalyticsAction.action.rawValue: AnalyticsAction.delete.rawValue])
            }
