...
final class InstructionViewController: PMBaseViewController {
    ...
    override func viewDidDisappear(_ animated: Bool) {
        ...
        AudioKitService.shared.setMusicMode(AudioKitService.shared.isMusicModeEnabled)
    }
    
    // MARK: - Private methods
    private func chargePlayer() {
        player.replaceCurrentItem(with: AVPlayerItem.init(url: Constants.URLs.hearingInstructions))
