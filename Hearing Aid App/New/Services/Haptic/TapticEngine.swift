...
open class TapticEngine {
    ...
    public static var isOn: Bool {
        set {
            UserDefaults.standard.setValue(newValue, forKey: "TapticOption")
            UserDefaults.standard.synchronize()
        }
        get {
            return (UserDefaults.standard.value(forKey: "TapticOption") as? Bool) ?? true
        }
    }
    ...
    open class Impact {
        ...
        public func feedback(_ style: ImpactStyle) {
            guard TapticEngine.isOn else { return }
