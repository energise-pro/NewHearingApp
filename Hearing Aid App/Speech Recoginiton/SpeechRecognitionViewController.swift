...
final class SpeechRecognitionViewController: BaseViewController, OrientationalProtocol {
    ...
    @IBAction func settingsAction(sender: UIButton) {
        ...
        AppConfigService.shared.analytics.track(action: .v2TranscribeScreen, with: [AnalyticsAction.action.rawValue: AnalyticsAction.settings.rawValue])
    }
    ...
    @IBAction func changeLanguageAction(sender: UIButton) {
        ...
        AppConfigService.shared.analytics.track(action: .v2TranscribeScreen, with: [AnalyticsAction.action.rawValue: AnalyticsAction.changeLanguage.rawValue])
    }
    ...
    @IBAction func rotate(sender: UIButton) {
        ...
        AppConfigService.shared.analytics.track(action: .v2TranscribeScreen, with: [AnalyticsAction.action.rawValue: AnalyticsAction.rotate.rawValue])
    }
        ...
        SpeechRecognition.requestAuthorization {[weak self] isAuthorization in
            ...
            if !isAuthorization {
                ...
                if !self.menuView.isRecognitionButtonSelected {
                    ...
                    AppConfigService.shared.analytics.track(action: .v2TranscribeScreen, with: [AnalyticsAction.action.rawValue: "\(AnalyticsAction.microphone.rawValue)_\(AnalyticsAction.enable.rawValue)"])
                    
                    UIApplication.shared.isIdleTimerDisabled = true
                    TapticEngine.customHaptic.playOn()
                    AudioKitService.shared.countOfUsingRecognize % 3 == 0 ? AppConfigService.shared.settings.presentAppRatingAlert() : Void()
                    ...
                    AppConfigService.shared.analytics.track(action: .v2TranscribeScreen, with: [AnalyticsAction.action.rawValue: "\(AnalyticsAction.microphone.rawValue)_\(AnalyticsAction.disable.rawValue)"])
    ...
    @IBAction func fullScreenAction(sender:UIButton) {
        AppConfigService.shared.analytics.track(action: .v2TranscribeScreen, with: [AnalyticsAction.action.rawValue: AnalyticsAction.fullScreen.rawValue])
