...
protocol GSpeRecSettiDelegate: AnyObject {
...
final class JSpeechRecoSetViewController: UMainViewController {
    ...
    weak var delegate: GSpeRecSettiDelegate?
...
//            }
//        }
//        KAppConfigServic.shared.analytics.track(action: .settingsHearingAid, with: [GAppAnalyticActions.parameters.rawValue: analyticsParams])
    }
}

extension JSpeechRecoSetViewController: UITableViewDataSource, UITableViewDelegate {
