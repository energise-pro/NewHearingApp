...
extension SettingsViewController: SettingTableViewCellDelegate {
    ...
    func didSelectButton(with type: SettingTableViewButtonType, from cell: SettingTableViewCell) {
        ...
        case 2: // Restore
            ...
            AppConfigService.shared.analytics.track(action: .v2SettingsScreen, with: [AnalyticsAction.action.rawValue: AnalyticsAction.restore.rawValue])
        case 3: // App icon
            NavigationManager.shared.presentAppIconsViewController()
            
            AppConfigService.shared.analytics.track(.v2SettingsScreen, with: [AnalyticsAction.action.rawValue: AnalyticsAction.changeAppIcon.rawValue])
        case 4: // Haptic
            switch type {
            case .info:
                presentAlertPM(title: "Info".localized(), message: "Disable or Enable vibrations when you press UI buttons".localized())
                
                AppConfigService.shared.analytics.track(action: .v2SettingsScreen, with: [AnalyticsAction.action.rawValue: "\(AnalyticsAction.haptic.rawValue)_\(AnalyticsAction.info.rawValue)"])
            case .switchButton:
                ...
                AppConfigService.shared.analytics.track(action: .v2SettingsScreen, with: [AnalyticsAction.action.rawValue: "\(AnalyticsAction.haptic.rawValue)_\(stringState)"])
            default:
                break
            }
        case 5: // FAQ
            ...
            AppConfigService.shared.analytics.track(.v2SettingsScreen, with: [AnalyticsAction.action.rawValue: AnalyticsAction.faq.rawValue])
        case 6: // Website
            NavigationManager.shared.presentSafariViewController(with: Constants.URLs.ourWebSiteURL)
            
            AppConfigService.shared.analytics.track(.v2SettingsScreen, with: [AnalyticsAction.action.rawValue: AnalyticsAction.ourWebsite.rawValue])
        case 7: // More
            NavigationManager.shared.presentMoreViewController()
            
            AppConfigService.shared.analytics.track(action: .v2SettingsScreen, with: [AnalyticsAction.action.rawValue: AnalyticsAction.more.rawValue])
        case 8: // Support
            NavigationManager.shared.presentSupportViewController()
            
            AppConfigService.shared.analytics.track(action: .v2SettingsScreen, with: [AnalyticsAction.action.rawValue: AnalyticsAction.support.rawValue])
        default:
            break
        }
    }
...
extension SettingsViewController: ThemeTableViewCellDelegate {
    ...
    func didSelectTheme(with type: ColorType, from cell: ThemeTableViewCell) {
        ...
        AppConfigService.shared.analytics.track(action: .v2SettingsScreen, with: [AnalyticsAction.action.rawValue: "\(AnalyticsAction.select.rawValue)_\(type.analyticAction.rawValue)"])
    }
}
