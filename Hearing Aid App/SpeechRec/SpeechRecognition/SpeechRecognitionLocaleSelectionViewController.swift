...
protocol BSpRecLocaleSelectionDelegate: AnyObject {
...
class DSpeechRecLocaleSelecViewController: UITableViewController {

    var locales: [Locale] = SpeechRecognition.supportedLocales()
    private let reuseIdentifier = "localeCell"
    weak var selectionDelegate: BSpRecLocaleSelectionDelegate?
