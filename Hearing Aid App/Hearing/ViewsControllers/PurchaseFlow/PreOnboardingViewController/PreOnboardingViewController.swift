...
final class PreOnboardingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        AppConfiguration.shared.analytics.track(.v2PreOnboardingScreen, with: [GAppAnalyticActions.action.rawValue: GAppAnalyticActions.open.rawValue])
        configureUI()
    }
    ...
    @IBAction private func nextButtonAction(_ sender: UIButton) {
        ...
        AppConfiguration.shared.analytics.track(.v2PreOnboardingScreen, with: [GAppAnalyticActions.action.rawValue: GAppAnalyticActions.continue.rawValue])
    }
    ...
    @IBAction private func questionButtonAction(_ sender: UIButton) {
        ...
        TapticEngine.impact.feedback(.medium)
        AppConfiguration.shared.analytics.track(.v2PreOnboardingScreen, with: [GAppAnalyticActions.action.rawValue: type.analyticAction.rawValue])
