...
final class LanguageSetupViewController: PMUMainViewController {
...
extension LanguageSetupViewController: SettingTableViewCellDelegate {
    ...
    func didSelectButton(with type: SettingTableViewButtonType, from cell: SettingTableViewCell) {
        ...
        case 1: // Translate language
            AppsNavManager.shared.pushLocalesListViewController(with: .translateTo, with: self)
        ...
        case 2: // Your language
            AppsNavManager.shared.pushLocalesListViewController(with: .translateFrom, with: self)
