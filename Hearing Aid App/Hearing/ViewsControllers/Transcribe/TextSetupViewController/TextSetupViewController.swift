...
final class TextSetupViewController: PMUMainViewController {
...
extension TextSetupViewController: HTexParamTableViewCellDelegate {
...
extension TextSetupViewController: SettingTableViewCellDelegate {
    ...
    func didSelectButton(with type: SettingTableViewButtonType, from cell: SettingTableViewCell) {
        ...
        case 1 where screenType == .transcribe: // Locale
            AppsNavManager.shared.pushLocalesListViewController(with: screenType == .transcribe ? .transcribe : .translateFrom, with: self)
