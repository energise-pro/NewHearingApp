...
final class TranscriptsListViewController: PMUMainViewController {
...
extension TranscriptsListViewController: GTranscriptionTablViewCellDelegate {
    ...
    func didSelectTranscript(from cell: GTranscriptionTablViewCell) {
        ...
        AppsNavManager.shared.pushTranscriptDetailsViewController(with: transcriptModel, and: self)
