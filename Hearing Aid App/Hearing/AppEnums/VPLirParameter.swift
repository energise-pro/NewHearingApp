...
enum MicroFineType: Int, CaseIterable {
    case bottom
    case front
    case back
    case headphones
    
    static var defaultMicrophone = MicroFineType.bottom
    
    static var selectedMicrophone: MicroFineType {
        set {
        ...
        get {
            ...
            let savedMicroFineType = MicroFineType(rawValue: intValue)!
            return savedMicroFineType == .headphones && !SAudioKitServicesAp.shared.connectedHeadphones ? defaultMicrophone : savedMicroFineType
        }
    }
...
enum PdShParam: String, CaseIterable {
...
enum VPLirParameter: String, CaseIterable {
