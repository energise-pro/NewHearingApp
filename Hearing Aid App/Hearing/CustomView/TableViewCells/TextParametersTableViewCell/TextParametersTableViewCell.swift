...
final class HTexParamTableViewCell: UITableViewCell, HConfigCellProtocol, UIViewCellNib {
    ...
    private func configureUI() {
        ...
        fontWeightLabels.enumerated().forEach { $0.element.textColor = $0.offset == GTranscribTextParam.FontWeight.value ? ThemeService.shared.activeColor : UIColor.label }
        
        alignmentImageViews.enumerated().forEach { $0.element.tintColor = $0.offset == GTranscribTextParam.TextAlignment.value ? ThemeService.shared.activeColor : UIColor.label }
    }
