...
final class InAppPurchasesService: NSObject, IServiceProtocol {
    ...
    var wasUsedTrial: Bool {
        get {
            return Bool(KeychainService.stringForKey(keyName: CAppConstants.Keys.wasUsedTrial) ?? "") ?? false
        }
        set {
            KeychainService.setString(value: newValue.toString() ?? "", forKey: CAppConstants.Keys.wasUsedTrial)
        }
    }
