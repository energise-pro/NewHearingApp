...
final class JOnbrdCollectViewCell: UICollectionViewCell {
    ...
    private func configureUI() {
        ...
        continueButton.backgroundColor = AThemeServicesAp.shared.activeColor
    ...
    func updateStateButton(asActive: Bool, button: OnboardingButtons) {
        switch button {
        case .after:
            afterTitleLabel.textColor = asActive ? AThemeServicesAp.shared.activeColor : UIColor.appColor(.UnactiveButton_2)
            rightButtonImageView.tintColor = asActive ? AThemeServicesAp.shared.activeColor : UIColor.appColor(.UnactiveButton_2)
        case .before:
            beforeTitleLabel.textColor = asActive ? AThemeServicesAp.shared.activeColor : UIColor.appColor(.UnactiveButton_2)
            leftButtonImageView.tintColor = asActive ? AThemeServicesAp.shared.activeColor : UIColor.appColor(.UnactiveButton_2)
        }
    }
