...
struct JEqlizeTableViewCellModel {
    var dataSource: [Double]
}

typealias JEqlizeTableViewCellConfig = АViewCellConfig<JEqlizeTableViewCell, JEqlizeTableViewCellModel>

final class JEqlizeTableViewCell: UITableViewCell, HConfigCellProtocol, UIViewCellNib {

    typealias DataType = JEqlizeTableViewCellModel
    ...
    private var dataModel: AASeriesElement {
        let colorData = AAGradientColor.linearGradient(direction: .toBottomRight, startColor: AThemeServicesAp.shared.activeColor.hexColor, endColor: AThemeServicesAp.shared.activeColor.hexColor)
    ...
    private func configureChartView() {
        ...
        aaChartModel.chartType(.areaspline)
                    ...
                    //.axesTextColor(AThemeServicesAp.shared.activeColor.hexColor)
                    .backgroundColor(AThemeServicesAp.shared.isDarkModeEnabled ? (UIColor.appColor(.BackgroundColor_1)?.hexColor ?? "#000000") : "#FFFFFF")
