...
//    }
    ...
    private func configureDataSource() {
        ...
        let statusCellModel = SettingTableViewCellModel(attributedTitle: NSAttributedString(string: "Compressor status".localized(), attributes: [.font: UIFont.systemFont(ofSize: 17.0, weight: .bold), .foregroundColor: UIColor.appColor(.Purple100)!]),
...
extension KCompresViewController: GSlideBTablViewCellDelegate {
    ...
    func didChangeSliderValue(on value: Float, from cell: GSlideBTablViewCell) {
        ...
        SAudioKitServicesAp.shared.changeCompressorValue(on: Double(value), for: compressorParameter)
