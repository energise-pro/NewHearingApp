...
final class KCompresViewController: PMUMainViewController {
    ...
    private func configureDataSource() {
        ...
        let statusCellModel = SettingTableViewCellModel(title: "Compressor status".localized(), buttonTypes: [.info, .switchButton], switchState: SAudioKitServicesAp.shared.isCompressorEnabled, delegate: self)
