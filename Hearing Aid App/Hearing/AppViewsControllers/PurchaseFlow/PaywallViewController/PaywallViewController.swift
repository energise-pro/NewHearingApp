...
final class PaywallViewController: UIViewController {
    ...
    private func configureUI() {
        ...
        [containerButtonYearly, containerButtonMonthly].forEach {
            $0?.backgroundColor = AThemeServicesAp.shared.activeColor
        }
        
        infoImageViews.forEach { $0.tintColor = AThemeServicesAp.shared.activeColor }
        ...
        subTitleLabel.textColor = AThemeServicesAp.shared.activeColor
