...
final class АViewCellConfig<CellType: HConfigCellProtocol, DataType>: CellConfigurator where CellType.DataType == DataType, CellType: UIViewCellNib {
