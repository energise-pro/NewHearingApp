...
class UMainViewController: UIViewController {
    ...
    static func instantiate<T:UMainViewController>() -> T {
...
class FBasPopovViewController: UMainViewController {
    ...
    @discardableResult
    static func presentOn<T:FBasPopovViewController>(controller: UIViewController,
                                                       inView view: UIView,
...
func presentError(error: Error? = nil,
    ...
    let vc = UIApplication.shared.topDAppViewController()
