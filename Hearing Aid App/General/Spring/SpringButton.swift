...
open class SpringButton: UIButton, Springable, KGradientablView {
    ...
    private func setupGradient() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(setupGradientColor), name: ThemeDidChangeNotificationName, object: nil)
    }
    ...
    @objc private func setupGradientColor() {
        ...
        let colors = isSelected ? theme.gradientColors : theme.gradientInactiveColors
        updateGradientColors(colors: colors)
    }
